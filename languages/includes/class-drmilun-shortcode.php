...
add_shortcode( "milun_search_woo", [$this, "add_search_box_2"] );             
...
<?php 
            ...
            $custom = get_post_meta( esc_attr($post->ID) );
                              ...
                              echo '<input type="hidden" id="numberofwordsinposts" value="'.esc_attr(get_post_meta($post->ID, 'numberofwordsinposts', true)).'" >';
...
echo wp_kses( $popup_form, $allowed_html );
...
echo wp_kses( $popup_form_without_categories, $allowed_html );
 ...
 <div class="before_loop_full_width">
    ...
    <div class="notification-container_before_loop_full_width">
        ...
        <div class="wrapper-data-container-before_loop_full_width-data-posts">
            <div class="data-categories-container-before_loop_full_width"></div>
...
$title_full_width = '
 <div class="title_full_width">
    <span class="dashicons dashicons-search"
          id="open-search-flyout-title_full_width"
          aria-label="Search"
          role="button"
          tabindex="0"></span>

    <div class="notification-container_title_full_width">
        <div class="search_title_full_width" style="background-color:transparent;">
            <span class="dashicons dashicons-no-alt closeFilePanel_full_width"
                  id="close-search-flyout-title_full_width"
                  aria-label="Close Search"
                  role="button"
                  tabindex="0"></span>

            <input type="text"
                   class="search-term-title_full_width"
                   placeholder="Search..." />
        </div>

        <div class="wrapper-data-container-title_full_width-data-posts">
            <div class="data-categories-container-title_full_width"></div>
            <div class="data-container-title_full_width"></div>
            <div class="data-posts-inc-title_full_width"></div>
            <div class="data-title_full_width-posts-btn"></div>
            <div class="no-data-title_full_width"></div>
        </div>
    </div>
</div>
';

$title_full_width_without_categories = '
 <div class="title_full_width">
    <span class="dashicons dashicons-search"
          id="open-search-flyout-title_full_width"
          aria-label="Search"
...
if (
    ...
    in_array($menu_args->theme_location, [$key], true)
     ...
     echo wp_kses($title_full_width.$items, $allowed_html);
...
if (
    ...
    in_array($menu_args->theme_location, [$key], true)
         ...
         echo wp_kses($title_full_width_without_categories.$items, $allowed_html);
...
if (
    ...
    in_array($menu_args->theme_location, [$key], true)
     ...
     echo wp_kses($items. $title_full_width, $allowed_html);
...
if (
    ...
    in_array($menu_args->theme_location, [$key], true)
     ...
     echo wp_kses($items. $title_full_width_without_categories, $allowed_html);
...
if (
    ...
    // Append popup + icon to the existing menu items
                          ...
                          echo wp_kses($popup_form. $items, $allowed_html);
 ...
 echo wp_kses($popup_form_without_categories. $items, $allowed_html);
   ...
   if (
    ...
    // Append popup + icon to the existing menu items
                       ...
                       echo wp_kses($items.$popup_form, $allowed_html);
    ...
    // Append popup + icon to the existing menu items
        ...
        echo wp_kses($items.$popup_form_without_categories, $allowed_html);
  ...
  <div class="shortcode_full_width">
        <div class="notification-container_shortcode_full_width">
            ...
            <div class="wrapper-data-container-shortcode_full_width-data-posts">
                <div class="data-categories-container-shortcode_full_width"></div>
