...
class MMSDD_Drmilun_Public {
	 ...
	 */
	 ...
	 public function enqueue_styles() {
        ...
        wp_enqueue_style( 'title-full-width', plugin_dir_url( __FILE__ ) . '../public/css/title-full-width.css', array(), '1.0', 'all' );
...
/* full width after title */
     wp_register_script(
    'title-full-width',
    plugin_dir_url( __FILE__ ) . '../public/js/title-full-width.js',
    array( 'jquery'),
    '1.0',
    true
);

wp_enqueue_script( 'title-full-width' );
...
wp_register_script(
    'main-full-width-title',
    plugin_dir_url( __FILE__ ) . '../public/js/main-full-width-title.js',
    array( 'jquery' ),
    '1.0',
    true
);

wp_enqueue_script( 'main-full-width-title' );
...
// settings before main loop full width
wp_register_script(
    'settings-before-loop-full-width',
    plugin_dir_url( __FILE__ ) . '../public/js/settings-before-loop-full-width.js',
    array( 'jquery' ),
    '1.0',
    true
);

wp_enqueue_script( 'settings-before-loop-full-width' );
...
wp_register_script(
    'show-result-title-full-width',
    plugin_dir_url( __FILE__ ) . '../public/js/show_result_title_full_width.js',
    array( 'jquery' ),
    '1.0',
    true
);

wp_enqueue_script( 'show-result-title-full-width' );
