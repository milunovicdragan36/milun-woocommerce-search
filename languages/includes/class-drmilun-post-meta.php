...
function namespace_register_search_woo_categories_double_two_words() {
      register_rest_route(
        'namespacewoo/v12',
        '/searching_woo_categories/(?P<s>[a-zA-Z0-9-]+)(?P<s_extra>[a-zA-Z0-9-]+)%20(?P<se>[a-zA-Z0-9-]+)/(?P<id>\d+)',
        [
            'methods'             => WP_REST_Server::READABLE, // GET
            'callback'            => [ $this, 'namespace_searching_woo_categories' ],
            'permission_callback' => '__return_true',
...
function namespace_register_search_woo_categories_two_words_and_half() {
      register_rest_route(
        'namespacewoo/v12',
        '/searching_woo_categories/(?P<s>[a-zA-Z0-9-]+)%20(?P<s_extra>[a-zA-Z0-9-]+)%20/(?P<id>\d+)',
        [
            'methods'             => WP_REST_Server::READABLE, // GET
            'callback'            => [ $this, 'namespace_searching_woo_categories' ],
            'permission_callback' => '__return_true',
...
$datepicker_1 = isset($custom['datepicker_1' . $post_id][0]) ? $custom['datepicker_1' . $post_id][0] : '';
$datepicker_2 = isset($custom['datepicker_2' . $post_id][0]) ? $custom['datepicker_2' . $post_id][0] : '';?>
<h4><?php esc_html_e('Date range of posts:', 'milun-woo-search'); ?></h4>
<p style="font-size: 15px;">
    <?php esc_html_e('Start Date: ', 'milun-woo-search'); ?>
    <input type="text" name="datepicker_1" id="datepicker_1" value="<?php echo esc_attr($datepicker_1); ?>">
</p>
<p style="font-size: 15px;">
    <?php esc_html_e('End Date: ', 'milun-woo-search'); ?>
    <input type="text" name="datepicker_2" id="datepicker_2" value="<?php echo esc_attr($datepicker_2); ?>">
</p>
<?php
