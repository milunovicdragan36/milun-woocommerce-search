...
$files_record = $wpdb->get_results( $wpdb->prepare("SELECT * from wp_posts 
   ...
   WHERE  wp_posts.post_title LIKE %s AND wp_posts.post_title LIKE %s AND wp_posts.post_title LIKE %s AND wp_posts.post_date > %s AND
...
$files_record = $wpdb->get_results( $wpdb->prepare("SELECT * from wp_posts 
   ...
   WHERE wp_posts.post_password!='' AND wp_posts.post_title LIKE %s AND wp_posts.post_title LIKE %s AND wp_posts.post_title LIKE %s AND wp_posts.post_date > %s AND
   wp_posts.post_status = 'publish' AND wp_posts.post_type != 'sfp_search_post'  AND wp_posts.post_type = 'product'
  ||  wp_posts.post_type = 'product_variation' AND wp_posts.post_password!='' AND 
 wp_posts.post_title LIKE %s AND wp_posts.post_title LIKE %s AND wp_posts.post_title LIKE %s AND wp_posts.post_date > %s AND
   wp_posts.post_status = 'publish' AND wp_posts.post_type != 'sfp_search_post'
...
$files_record = $wpdb->get_results( $wpdb->prepare("SELECT * from wp_posts 
   ...
   WHERE  wp_posts.post_title LIKE %s AND wp_posts.post_title LIKE %s AND wp_posts.post_title LIKE %s AND wp_posts.post_date > %s AND wp_posts.post_date < %s AND
   wp_posts.post_status = 'publish' AND wp_posts.post_type != 'sfp_search_post'  AND wp_posts.post_type = 'product'
  ||  wp_posts.post_type = 'product_variation' AND 
 wp_posts.post_title LIKE %s AND wp_posts.post_title LIKE %s AND wp_posts.post_title LIKE %s AND wp_posts.post_date > %s AND wp_posts.post_date < %s AND
   wp_posts.post_status = 'publish' AND wp_posts.post_type != 'sfp_search_post'
...
$files_record = $wpdb->get_results( $wpdb->prepare("SELECT * from wp_posts 
   ...
   WHERE  wp_posts.post_password!='' AND wp_posts.post_title LIKE %s AND wp_posts.post_title LIKE %s AND wp_posts.post_title LIKE %s AND wp_posts.post_date > %s AND wp_posts.post_date < %s AND
   wp_posts.post_status = 'publish' AND wp_posts.post_type != 'sfp_search_post'  AND wp_posts.post_type = 'product'
  ||  wp_posts.post_type = 'product_variation' AND wp_posts.post_password!='' AND 
 wp_posts.post_title LIKE %s AND wp_posts.post_title LIKE %s AND wp_posts.post_title LIKE %s AND wp_posts.post_date > %s AND wp_posts.post_date < %s AND
   wp_posts.post_status = 'publish' AND wp_posts.post_type != 'sfp_search_post'
...
$files_record = $wpdb->get_results( $wpdb->prepare("SELECT * from wp_posts 
   ...
   WHERE  wp_posts.post_title LIKE %s  AND wp_posts.post_title LIKE %s  AND wp_posts.post_title LIKE %s
   wp_posts.post_status = 'publish' AND wp_posts.post_type != 'sfp_search_post'  AND wp_posts.post_type = 'product'
  ||  wp_posts.post_type = 'product_variation' AND 
 wp_posts.post_title LIKE %s AND wp_posts.post_title LIKE %s AND wp_posts.post_title LIKE %s
   wp_posts.post_status = 'publish' AND wp_posts.post_type != 'sfp_search_post'
...
$files_record = $wpdb->get_results( $wpdb->prepare("SELECT * from wp_posts 
   ...
   WHERE  wp_posts.post_password!='' AND wp_posts.post_title LIKE %s AND wp_posts.post_title LIKE %s AND wp_posts.post_title LIKE %s AND
   wp_posts.post_status = 'publish' AND wp_posts.post_type != 'sfp_search_post'  AND wp_posts.post_type = 'product'
  ||  wp_posts.post_type = 'product_variation' AND wp_posts.post_password!='' AND 
 wp_posts.post_title LIKE %s AND wp_posts.post_title LIKE %s AND wp_posts.post_title LIKE %s
   wp_posts.post_status = 'publish' AND wp_posts.post_type != 'sfp_search_post'
...
$files_record = $wpdb->get_results( $wpdb->prepare("SELECT * from wp_posts 
   ...
   WHERE  wp_posts.post_password='' AND wp_posts.post_title LIKE %s AND wp_posts.post_title LIKE %s AND wp_posts.post_title LIKE %s
   wp_posts.post_status = 'publish' AND wp_posts.post_type != 'sfp_search_post'  AND wp_posts.post_type = 'product'
  ||  wp_posts.post_type = 'product_variation' AND wp_posts.post_password='' AND 
 wp_posts.post_title LIKE %s AND wp_posts.post_title LIKE %s AND wp_posts.post_title LIKE %s
   wp_posts.post_status = 'publish' AND wp_posts.post_type != 'sfp_search_post'
...
$files_record = $wpdb->get_results( $wpdb->prepare("SELECT * from wp_posts 
   ...
   WHERE  wp_posts.post_content LIKE %s AND wp_posts.post_content LIKE %s AND wp_posts.post_content LIKE %s AND wp_posts.post_date > %s AND
   wp_posts.post_status = 'publish' AND wp_posts.post_type != 'sfp_search_post'  AND wp_posts.post_type = 'product'
  ||  wp_posts.post_type = 'product_variation' AND 
...
$files_record = $wpdb->get_results( $wpdb->prepare("SELECT * from wp_posts 
   ...
   WHERE wp_posts.post_password!='' AND wp_posts.post_content LIKE %s AND wp_posts.post_content LIKE %s AND wp_posts.post_content LIKE %s AND wp_posts.post_date > %s AND
   wp_posts.post_status = 'publish' AND wp_posts.post_type != 'sfp_search_post'  AND wp_posts.post_type = 'product'
  ||  wp_posts.post_type = 'product_variation' AND wp_posts.post_password!='' AND 
 wp_posts.post_content LIKE %s AND wp_posts.post_content LIKE %s AND wp_posts.post_content LIKE %s AND wp_posts.post_date > %s AND
   wp_posts.post_status = 'publish' AND wp_posts.post_type != 'sfp_search_post'
...
$files_record = $wpdb->get_results( $wpdb->prepare("SELECT * from wp_posts 
   ...
   WHERE  wp_posts.post_content LIKE %s AND wp_posts.post_content LIKE %s AND wp_posts.post_content LIKE %s AND wp_posts.post_date > %s AND wp_posts.post_date < %s AND
   wp_posts.post_status = 'publish' AND wp_posts.post_type != 'sfp_search_post'  AND wp_posts.post_type = 'product'
  ||  wp_posts.post_type = 'product_variation' AND 
 wp_posts.post_content LIKE %s AND wp_posts.post_content LIKE %s AND wp_posts.post_content LIKE %s AND wp_posts.post_date > %s AND wp_posts.post_date < %s AND
   wp_posts.post_status = 'publish' AND wp_posts.post_type != 'sfp_search_post'
...
$files_record = $wpdb->get_results( $wpdb->prepare("SELECT * from wp_posts 
   ...
   WHERE  wp_posts.post_password!='' AND wp_posts.post_content LIKE %s AND wp_posts.post_content LIKE %s AND wp_posts.post_content LIKE %s AND wp_posts.post_date > %s AND wp_posts.post_date < %s AND
   wp_posts.post_status = 'publish' AND wp_posts.post_type != 'sfp_search_post'  AND wp_posts.post_type = 'product'
  ||  wp_posts.post_type = 'product_variation' AND wp_posts.post_password!='' AND 
 wp_posts.post_content LIKE %s AND wp_posts.post_content LIKE %s AND wp_posts.post_content LIKE %s AND wp_posts.post_date > %s AND wp_posts.post_date < %s AND
   wp_posts.post_status = 'publish' AND wp_posts.post_type != 'sfp_search_post'
...
$files_record = $wpdb->get_results( $wpdb->prepare("SELECT * from wp_posts 
   ...
   WHERE  wp_posts.post_content LIKE %s  AND wp_posts.post_content LIKE %s   AND wp_posts.post_content LIKE %s AND
   wp_posts.post_status = 'publish' AND wp_posts.post_type != 'sfp_search_post'  AND wp_posts.post_type = 'product'
  ||  wp_posts.post_type = 'product_variation' AND 
 wp_posts.post_content LIKE %s AND wp_posts.post_content LIKE %s AND wp_posts.post_content LIKE %s AND 
   wp_posts.post_status = 'publish' AND wp_posts.post_type != 'sfp_search_post'
...
$files_record = $wpdb->get_results( $wpdb->prepare("SELECT * from wp_posts 
   ...
   WHERE  wp_posts.post_password!='' AND wp_posts.post_content LIKE %s AND wp_posts.post_content LIKE %s  AND wp_posts.post_content LIKE %s AND
   wp_posts.post_status = 'publish' AND wp_posts.post_type != 'sfp_search_post'  AND wp_posts.post_type = 'product'
  ||  wp_posts.post_type = 'product_variation' AND wp_posts.post_password!='' AND 
 wp_posts.post_content LIKE %s AND wp_posts.post_content LIKE %s AND wp_posts.post_content LIKE %s AND 
   wp_posts.post_status = 'publish' AND wp_posts.post_type != 'sfp_search_post'
