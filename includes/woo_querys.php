...
$files_record = $wpdb->get_results( $wpdb->prepare("SELECT * from $wpdb->posts 
   ...
   WHERE  $wpdb->posts.post_title LIKE %s AND $wpdb->posts.post_date > %s AND
...
$files_record = $wpdb->get_results( $wpdb->prepare("SELECT * from $wpdb->posts 
   ...
   WHERE $wpdb->posts.post_password!='' AND $wpdb->posts.post_title LIKE %s AND $wpdb->posts.post_date > %s AND
   $wpdb->posts.post_status = 'publish' AND $wpdb->posts.post_type != 'sfp_search_post'  AND $wpdb->posts.post_type = 'product'
...
", '%' . $wpdb->esc_like($post_slug) . '%',$datepicker_2, '%' . $wpdb->esc_like($post_slug) . '%',$datepicker_2));
}
...
$files_record = $wpdb->get_results( $wpdb->prepare("SELECT * from $wpdb->posts 
   ...
   WHERE  $wpdb->posts.post_title LIKE %s AND $wpdb->posts.post_date > %s AND $wpdb->posts.post_date < %s AND
   $wpdb->posts.post_status = 'publish' AND $wpdb->posts.post_type != 'sfp_search_post'  AND $wpdb->posts.post_type = 'product'
  ||  $wpdb->posts.post_type = 'product_variation' AND 
 $wpdb->posts.post_title LIKE %s AND $wpdb->posts.post_date > %s AND $wpdb->posts.post_date < %s AND
   $wpdb->posts.post_status = 'publish' AND $wpdb->posts.post_type != 'sfp_search_post'
   
", '%' . $wpdb->esc_like($post_slug) . '%',$datepicker_1,$datepicker_2, '%' . $wpdb->esc_like($post_slug) . '%',$datepicker_1,$datepicker_2));
}
...
$files_record = $wpdb->get_results( $wpdb->prepare("SELECT * from $wpdb->posts 
   ...
   WHERE  $wpdb->posts.post_password!='' AND $wpdb->posts.post_title LIKE %s AND $wpdb->posts.post_date > %s AND $wpdb->posts.post_date < %s AND
   $wpdb->posts.post_status = 'publish' AND $wpdb->posts.post_type != 'sfp_search_post'  AND $wpdb->posts.post_type = 'product'
  ||  $wpdb->posts.post_type = 'product_variation' AND $wpdb->posts.post_password!='' AND 
 $wpdb->posts.post_title LIKE %s AND $wpdb->posts.post_date > %s AND $wpdb->posts.post_date < %s AND
   $wpdb->posts.post_status = 'publish' AND $wpdb->posts.post_type != 'sfp_search_post'
...
", '%' . $wpdb->esc_like($post_slug) . '%','%' . $wpdb->esc_like($post_slug) . '%'));
}
...
$files_record = $wpdb->get_results( $wpdb->prepare("SELECT * from $wpdb->posts 
   ...
   WHERE  $wpdb->posts.post_password!='' AND $wpdb->posts.post_title LIKE %s AND
   $wpdb->posts.post_status = 'publish' AND $wpdb->posts.post_type != 'sfp_search_post'  AND $wpdb->posts.post_type = 'product'
  ||  $wpdb->posts.post_type = 'product_variation' AND $wpdb->posts.post_password!='' AND 
 $wpdb->posts.post_title LIKE %s AND 
   $wpdb->posts.post_status = 'publish' AND $wpdb->posts.post_type != 'sfp_search_post'
...
$files_record = $wpdb->get_results( $wpdb->prepare("SELECT * from $wpdb->posts 
   ...
   WHERE  $wpdb->posts.post_content LIKE %s AND $wpdb->posts.post_date > %s AND
   $wpdb->posts.post_status = 'publish' AND $wpdb->posts.post_type != 'sfp_search_post'  AND $wpdb->posts.post_type = 'product'
  ||  $wpdb->posts.post_type = 'product_variation' AND 
...
$files_record = $wpdb->get_results( $wpdb->prepare("SELECT * from $wpdb->posts 
   ...
   WHERE $wpdb->posts.post_password!='' AND $wpdb->posts.post_content LIKE %s AND $wpdb->posts.post_date > %s AND
   $wpdb->posts.post_status = 'publish' AND $wpdb->posts.post_type != 'sfp_search_post'  AND $wpdb->posts.post_type = 'product'
  ||  $wpdb->posts.post_type = 'product_variation' AND $wpdb->posts.post_password!='' AND 
 $wpdb->posts.post_content LIKE %s AND $wpdb->posts.post_date > %s AND
   $wpdb->posts.post_status = 'publish' AND $wpdb->posts.post_type != 'sfp_search_post'
...
$files_record = $wpdb->get_results( $wpdb->prepare("SELECT * from $wpdb->posts 
   ...
   WHERE  $wpdb->posts.post_content LIKE %s AND $wpdb->posts.post_date > %s AND $wpdb->posts.post_date < %s AND
   $wpdb->posts.post_status = 'publish' AND $wpdb->posts.post_type != 'sfp_search_post'  AND $wpdb->posts.post_type = 'product'
  ||  $wpdb->posts.post_type = 'product_variation' AND 
 $wpdb->posts.post_content LIKE %s AND $wpdb->posts.post_date > %s AND $wpdb->posts.post_date < %s AND
   $wpdb->posts.post_status = 'publish' AND $wpdb->posts.post_type != 'sfp_search_post'
...
$files_record = $wpdb->get_results( $wpdb->prepare("SELECT * from $wpdb->posts 
   ...
   WHERE  $wpdb->posts.post_password!='' AND $wpdb->posts.post_content LIKE %s AND $wpdb->posts.post_date > %s AND $wpdb->posts.post_date < %s AND
   $wpdb->posts.post_status = 'publish' AND $wpdb->posts.post_type != 'sfp_search_post'  AND $wpdb->posts.post_type = 'product'
  ||  $wpdb->posts.post_type = 'product_variation' AND $wpdb->posts.post_password!='' AND 
 $wpdb->posts.post_content LIKE %s AND $wpdb->posts.post_date > %s AND $wpdb->posts.post_date < %s AND
   $wpdb->posts.post_status = 'publish' AND $wpdb->posts.post_type != 'sfp_search_post'
...
$files_record = $wpdb->get_results( $wpdb->prepare("SELECT * from $wpdb->posts 
   ...
   WHERE  $wpdb->posts.post_content LIKE %s  AND
   $wpdb->posts.post_status = 'publish' AND $wpdb->posts.post_type != 'sfp_search_post'  AND $wpdb->posts.post_type = 'product'
  ||  $wpdb->posts.post_type = 'product_variation' AND 
...
$files_record = $wpdb->get_results( $wpdb->prepare("SELECT * from $wpdb->posts 
   ...
   WHERE  $wpdb->posts.post_password!='' AND $wpdb->posts.post_content LIKE %s AND
   $wpdb->posts.post_status = 'publish' AND $wpdb->posts.post_type != 'sfp_search_post'  AND $wpdb->posts.post_type = 'product'
  ||  $wpdb->posts.post_type = 'product_variation' AND $wpdb->posts.post_password!='' AND 
 $wpdb->posts.post_content LIKE %s AND 
   $wpdb->posts.post_status = 'publish' AND $wpdb->posts.post_type != 'sfp_search_post'
