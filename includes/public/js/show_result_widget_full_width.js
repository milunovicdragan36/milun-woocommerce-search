...
document.getElementsByClassName('data-container-widget_full_width')[0].innerHTML =
  livesearchposts_2.map(item => {
    ...
    const contentHTML = item.post_content && item.post_content.trim() !== ''
      ? `<div class="content_widget_full_width" style="overflow:hidden; text-overflow:ellipsis; white-space:nowrap; font-size:12px;">
