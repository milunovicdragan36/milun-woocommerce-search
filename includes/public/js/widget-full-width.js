jQuery(document).ready(function ($) {
    var $panel = $('.notification-container_widget_full_width');
    var $open = $('#open-widget_full_width');
    var $close = $('#close-search-flyout-widget_full_width');
    var $input = $('.search-term-widget_full_width');
    ...
    $panel.on('click', function (e) {
        if ($(e.target).is('.notification-container_widget_full_width')) {
            closePanel();
        }
    });
