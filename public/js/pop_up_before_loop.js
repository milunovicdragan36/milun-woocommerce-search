(function ($) {
  ...
  function getPopup() {
    return $(".pop_up_before_loop.milun-popup-center").first();
  }
  ...
  function openPopup() {
    ...
    setTimeout(function () {
      $popup.find(".search-term-before-loop").first().trigger("focus");
    }, 80);
  }
  ...
  /* CLICK OUTSIDE CLOSE */
  $(document).on("click", ".pop_up_before_loop.milun-popup-center", function (e) {
