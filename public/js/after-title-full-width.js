jQuery(document).ready(function ($) {
    var $panel = $('.notification-container_after_title_full_width');
    var $open = $('#open-search-flyout-after-title_full_width');
    var $close = $('#close-search-flyout-after-title_full_width');
    var $input = $('.search-term-after_title_full_width');
    ...
    $panel.on('click', function (e) {
        if ($(e.target).is('.notification-container_after_title_full_width')) {
            closePanel();
        }
    });
