...
class Live_Search_After_Title_Full_Width{
  
  constructor(){
     this.searchFieldProductsAfterTitleFullWidth = jQuery(".search-term-after_title_full_width");
 this.searchFieldCategoriesAfterTitleFullWidth = jQuery(".search-term-after_title_full_width");
  this.searchFieldTagsAfterTitleFullWidth = jQuery(".search-term-after_title_full_width");
...
this.count = 0;
 this.number_of_words_in_posts = jQuery("#numberofwordsinposts");
     ...
     this.resultsDiv = jQuery(".search-term-after-loop");
     this.isSpinnerVisible = false;
     this.previousValue;
     this.timeout;
     this.i = 0;
           
this.searchFieldProductsAfterTitleFullWidth.on(
  "keyup",
  debounce(this.getResultsProductsAfterTitleFullWidth.bind(this), 400)
);

this.searchFieldCategoriesAfterTitleFullWidth.on(
  "keyup",
  debounce(this.getResultsCategoriesAfterTitleFullWidth.bind(this), 400)
);
...
jQuery(".data-container").css("display",'none');
  ...
  jQuery('.data-posts-inc-after_title_full_width').css('display','none');

 
  jQuery('.no_more_posts_after_title_full_width').css("display",'none');
  ...
  jQuery('.data-posts-inc-after-loop').css('display','none');
        ...
        jQuery('.no-data-after-loop').css('display','none');

jQuery(".wrapper-data-container-after_title_full_width-data-posts").css("display",'none');


 jQuery(".data-search_categories-container-after_title_full_width").css("display",'none');
  jQuery(".data-tags-container-after_title_full_width").css("display",'none');
  ...
  jQuery(".data-container-after_title_full_width").css("display",'none');
      ...
      jQuery('.data-after_title_full_width-posts-btn').css("display",'block');
...
jQuery(".wrapper-data-container-after_title_full_width-data-posts").css("display",'block');
  jQuery(".data-search_categories-container-after_title_full_width").css("display",'block');
...
var customSearchBox =this.searchFieldProductsAfterTitleFullWidth.val();
...
jQuery.getJSON(url, function (livesearchposts_1) {
  ...
  if (typeof window.milunShowResultAfterTitleFullWidth === "function") {
    window.milunShowResultAfterTitleFullWidth(livesearchposts_1);
  }
  
if (livesearchposts_1.length==0) {
  jQuery(".data-container-after_title_full_width").css("display","block");

    document.getElementsByClassName('data-container-after_title_full_width')[0].innerHTML =liveSearchDataPosts[0].not_found_data;
...
getResultsCategoriesAfterTitleFullWidth(){
const el = document.querySelector('.data-categories-container-after_title_full_width');
...
if (el) {
  ...
  setTimeout(function () {
    jQuery(".data-categories-container-after-loop")
      ...
      var customSearchBox =  $this.searchFieldCategoriesAfterTitleFullWidth.val();
...
if (result.length==0) {
  jQuery(".category-after_title_full_width-label").remove();


    document.getElementsByClassName('data-categories-container-after_title_full_width')[0].innerHTML =liveSearchDataCategories[0].not_found_data;
    ...
    document.getElementsByClassName('data-categories-container-after_title_full_width')[0].innerHTML =result;
...
var liveSearchAfterTitleFullWidth= new Live_Search_After_Title_Full_Width();
